---
title: "QTM 151"
subtitle: "Lab 2 - plotly and ggplotly <html><div style='float:left'></div><hr color='#f2a900' size=1px width=800px></html>"
...
Last class we learned `qplot`. It is a great function simple dataviz.

Do you have any questions about `qplot`?

I also posted a video to help you if you cannot load files using GitHub.

* The quiz for this class is on, due by the next class.
